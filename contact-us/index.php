          ...
          <div class="mdl-layout__content">
            <div class="demo-options mdl-card mdl-color--deep-purple-500 mdl-shadow--2dp mdl-cell mdl-cell--4-col mdl-cell--3-col-tablet mdl-cell--12-col-desktop">
              <div class="mdl-card__supporting-text mdl-color-text--blue-grey-50">
               <h4>&emsp;Mess Manager<h4>			   
				<ul> 
				<?php
					$data=mysqli_connect("localhost","root","","mess") or die();
					$db=mysqli_query($data,"SELECT `fname`,`lname` FROM login WHERE `messman`='1'");
					foreach($db as $d)
					{
						$mname=$d['fname'].' '.$d['lname'];
						echo "
						<li>                   
							<h5><i class='material-icons' style='font-size:18px;'>perm_identity</i>&nbsp;$mname</h5>
						</li>					
						<li>                 
							<i class='material-icons' style='font-size:18px;'>phone</i>&emsp;<span class='mdl-checkbox__label'>0267-2732266/67</span>
						</li>
						<li>                    
							<i class='material-icons' style='font-size:18px;'>email</i>&emsp;<a href='mailto:messmanager@hostel.com' style='text-decoration: none;color:inherit;;'>messmanager@hostel.com</a>
						</li>";
					}				  
				?>
                </ul>				
