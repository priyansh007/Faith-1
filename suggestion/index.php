  ...
  <body>
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <?php 
			if($loggedin && ($_SESSION['messman']==0))
			{
				echo "<div class='mdl-grid demo-content'>
					<div class='mdl-layout__content'>
						<div class='demo-updates mdl-card mdl-shadow--2dp mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--12-col-desktop'>
							<div class='mdl-card__title mdl-card--expand mdl-color--teal-300'>
								<h2 class='mdl-card__title-text'>Suggest food items you'd like to eat.</h2>
							</div>				
						</div>								
					</div>
				</div>
				...
				<div class='mdl-grid demo-content'>
					<form method='post' action='add.php' >					
						<div class='mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height'>
							<input class='mdl-textfield__input' type='text' name='foodtype' id='fid' value='' required readonly tabIndex='-1'>
								<label for='fid'>
									<i class='mdl-icon-toggle__label material-icons'>keyboard_arrow_down</i>
								</label>
								<label for='fid' class='mdl-textfield__label'></label>
								<ul for='fid' class='mdl-menu mdl-menu--bottom-left mdl-js-menu'>
									<li class='mdl-menu__item'>Breakfast</li>
									<li class='mdl-menu__item'>Lunch</li>
									<li class='mdl-menu__item'>Dinner</li>
								</ul>
						</div>
						<div class='mdl-textfield mdl-js-textfield mdl-textfield--expandable'>
							...
							<div class='mdl-textfield__expandable-holder'>
								<input class='mdl-textfield__input' type='text' name='foodname' id='search3' required='required'>
			...
			elseif($loggedin && ($_SESSION['messman']==1))
			{
				echo "<div class='mdl-grid demo-content'>
				  <div class='mdl-layout__content'>
				...
				$data=mysqli_connect("localhost","root","","mess") or die();
				$db=mysqli_query($data,"SELECT `suggfoodname` FROM `suggestion` WHERE `suggfoodtype`=1");
				if(mysqli_num_rows($db)==0)
				{
					echo "<tr style='width:inherit;'>								
					<td class='mdl-data-table__cell--non-numeric' style='vertical-align:baseline;'>No suggestions available</td>											
					</tr>";
				}
				else
				{
					...
					{					
						...
						echo "<tr>								
							...
							<td class='mdl-data-table__cell--non-numeric' style='vertical-align:baseline;'><a href='delete.php?food=$food&type=1' class='mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect' style='display:inline-block;'>Add</a></td>
							</tr>";
					}
				}
				echo "</tbody>
						...
						<div class='mdl-card mdl-cell mdl-shadow--2dp' style='width:inherit;'>
							...
							<table class='mdl-data-table mdl-js-data-table' style='border: none;width:100%;'>
								...
								<tbody>";
				$data=mysqli_connect("localhost","root","","mess") or die();
				$db=mysqli_query($data,"SELECT `suggfoodname` FROM `suggestion` WHERE `suggfoodtype`=2");
				if(mysqli_num_rows($db)==0)
				{
				...
				else
				{
					foreach ($db as $d)
					{
						...
						echo "<tr>								
							<td class='mdl-data-table__cell--non-numeric' style='vertical-align:baseline;'><b>$food</b></td>												
								<td class='mdl-data-table__cell--non-numeric' style='vertical-align:baseline;'><a href='delete.php?food=$food&type=2' class='mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect' style='display:inline-block;'>Add</a></td>
							  </tr>";
					}
				}				
				echo "				</tbody>
						...
						<div class='mdl-card mdl-cell mdl-shadow--2dp' style='width:inherit;'>
							...
							<table class='mdl-data-table mdl-js-data-table' style=' border: none;width:100%;'>
								<tbody>";
				$data=mysqli_connect("localhost","root","","mess") or die();
				$db=mysqli_query($data,"SELECT `suggfoodname` FROM `suggestion` WHERE `suggfoodtype`=3");
				if(mysqli_num_rows($db)==0)
				{
					echo "<tr style='width:100%;'>								
							<td class='mdl-data-table__cell--non-numeric' style='vertical-align:baseline;'>No suggestions available</td>
				...
				else
				{
					foreach ($db as $d)
					{
						...
						echo "<tr>								
								<td class='mdl-data-table__cell--non-numeric' style='vertical-align:baseline;'><b>$food</b></td>												
								<td class='mdl-data-table__cell--non-numeric' style='vertical-align:baseline;'><a href='delete.php?food=$food&type=3' class='mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect' style='display:inline-block;'>Add</a></td>
							  </tr>";
					}
				}
				echo"				</tbody>
