      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-grid demo-content">
			<?php
				...
				echo "<div class='mdl-layout-spacer'><br></div>
				<button class='mdl-button mdl-color--accent mdl-color-text--accent-contrast mdl-button--raised mdl-js-button mdl-js-ripple-effect' type='submit' name='addlunch'>Vote</button>
				</form>";
				}
			?>
        </div><br>
